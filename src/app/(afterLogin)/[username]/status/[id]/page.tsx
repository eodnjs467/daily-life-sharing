...
import style from "./detail-post.module.css";
      ...
      <div className={style.body}>
        <div className={style.post}>
          ...
          <div className={style.description}>
            무슨 기준으로, 어떻게 점수를 줬는지 투명하게 공개좀요
          </div>
          <div className={style.postInfo}>
            <div className={style.createdAt}> 오후 10:34 · 2024년 1월 2일 </div>
          ...
          <div className={style.actions}>
            <div className={style.commentButton}>
              <svg
                ...
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-50lct3 r-1srniue"
              >
                <g>
