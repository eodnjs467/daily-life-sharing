...
export default function ActionButtons() {
  ...
  return (
    <div className={style.actionButtons}>
      <div className={cx(style.commentButton, comment && style.commented)}>
      ...
      <div className={cx(style.repostButton, repost && style.reposted)}>
      ...
      <div className={cx(style.heartButton, heart && style.hearted)}>
