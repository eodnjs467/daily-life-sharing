            ...
            <div className={style.icons}>
              ...
              <div className={style.icon}>
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    {" "}
                    <path d="M0,439.5h170.7V268.8H0V439.5z M42.7,311.5H128v85.3H42.7V311.5z M213.3,418.2H512v-42.7H213.3V418.2z M0,226.2h170.7V55.5 H0V226.2z M42.7,98.2H128v85.3H42.7V98.2z M213.3,76.8v42.7H512V76.8H213.3z M213.3,332.8H512v-42.7H213.3V332.8z M213.3,204.8H512 v-42.7H213.3V204.8z"></path>{" "}
                  </g>
                </svg>
              </div>
              <div className={style.icon}>
